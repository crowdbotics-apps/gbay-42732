"""
Django settings for gbay_42732 project.
...
WSGI_APPLICATION = 'gbay_42732.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gbay_42732 API",
    "DESCRIPTION": "API documentation for gbay_42732 App",
    "VERSION": "v1",
}
